...
public class Dealership {
	...
	// Checks if the model of car (fiesta, punto etc) exists and if it does not,
	// adds the model. Then adds the car details to that.
	...
	/*
	 * Cars must have a unique regi plate, so cars can be identified by this. Loop
	 * // through all Makes then Models and get the value // Loop through all Makes
	 * then Models and get the Value which corresponds to a Car object.
